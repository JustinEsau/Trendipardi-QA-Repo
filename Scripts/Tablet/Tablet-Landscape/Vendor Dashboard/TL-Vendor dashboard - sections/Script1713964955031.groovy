...
WebUI.click(findTestObject('Object Repository/Vendor-Login/Vendor-dashboard/Vendor Mobile/button_Accept'))

WebUI.click(findTestObject('Object Repository/Homepage/Tablet-Homepage/a_Login  Register'))
...
WebUI.click(findTestObject('Object Repository/Dashboard/Tablet-Dashboard/a_See All'))
